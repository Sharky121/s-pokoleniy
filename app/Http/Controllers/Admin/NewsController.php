...
class NewsController extends Controller
{
    public function index(Request $request)
    {
        ...
        $widget = new CherrySite\Views\Common\Page(
            ...
            new CherrySite\Views\Common\Container([
                new CherrySite\Views\Common\Panel('Новости', [
                    new CherrySite\Views\Common\Breadcrumbs('admin.news.index'),
                    new CherrySite\Views\Common\CreateButton('admin.news.create'),
                ]),
                new CherrySite\Views\Widgets\Table\Layout([
                    ...
                    new CherrySite\Views\Widgets\Table\Actions('Действия', [
                        new CherrySite\Views\Widgets\Table\EditButton('admin.news.edit'),
                        new CherrySite\Views\Widgets\Table\DeleteButton('admin.news.destroy'),
                    ]),
                ], $paginator),
            ])
        );
    ...
    public function create(Request $request)
    {
        ...
        $widget = new CherrySite\Views\Common\Page(
            ...
            new CherrySite\Views\Common\Navbar(),
            new CherrySite\Views\Common\Container([
                new CherrySite\Views\Common\Panel('Новая новость', [
                    new CherrySite\Views\Common\Breadcrumbs('admin.news.create'),
                ]),
                new CherrySite\Views\Widgets\Form\TabsContainer([
                    new CherrySite\Views\Widgets\Form\TabItem('Основные настройки', [
                        new CherrySite\Views\Widgets\Form\Layout('admin.news.store', 'POST', [
    ...
    public function edit(Request $request, News $model)
    {
        $table = $model->getTable();
        ...
        $widget = new CherrySite\Views\Common\Page(
            ...
            new CherrySite\Views\Common\Navbar(),
            new CherrySite\Views\Common\Container([
                new CherrySite\Views\Common\Panel('Редактирование новости', [
                    new CherrySite\Views\Common\Breadcrumbs('admin.news.edit', $model),
                    new CherrySite\Views\Common\DeleteButton('admin.news.destroy'),
                ]),
                new CherrySite\Views\Widgets\Form\TabsContainer([
                    new CherrySite\Views\Widgets\Form\TabItem('Основные настройки', [
                        new CherrySite\Views\Widgets\Form\Layout('admin.news.update', 'PATCH', [
                            new CherrySite\Views\Widgets\Form\Text($table, 'title', 'Название'),
                            new CherrySite\Views\Widgets\Form\Text($table, 'place', 'Место'),
                            new CherrySite\Views\Widgets\Form\File($table, 'cover', 'Обложка'),
                            new CherrySite\Views\Widgets\Form\Wysiwyg($table, 'content_long', 'Описание, полное'),
                    ...
                    new CherrySite\Views\Widgets\Form\TabItem('Галлерея', [
                        new CherrySite\Views\Widgets\Form\HasManyToGallery(
                            ...
                            'path',
                            'position',
                            'admin.news_photos.batchStore',
                            'admin.news_photos.destroy',
                            'admin.news_photos.batchUpdate'
                        ),
                    ]),
                ]),
            ])
    ...
    public function store(Request $request)
    {
        ...
        $connection = News::resolveConnection();
        $query = News::query();
        ...
        if ($result->succeeded()) {
            ...
            return response()
                ->json(['redirectTo' => route('admin.news.edit', [$retriever->getModel()], false)]);
        }
    ...
    public function update(Request $request, News $model)
    {
        ...
        if ($result->succeeded()) {
            $request->session()->flash('success', $result->messages());
            return response()
                ->json(['redirectTo' => route('admin.news.index', [], false)]);
        }
    ...
    public function destroy(Request $request, News $model)
    {
