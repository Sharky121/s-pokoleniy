...
class ChurchesController extends Controller
{
    public function index(Request $request)
    {
        ...
        $widget = new CherrySite\Views\Common\Page(
            ...
            new CherrySite\Views\Common\Container([
                new CherrySite\Views\Common\Panel('Поддержка РПЦ', [
                    new CherrySite\Views\Common\Breadcrumbs('admin.churches.index'),
                    new CherrySite\Views\Common\CreateButton('admin.churches.create'),
                ]),
                new CherrySite\Views\Widgets\Table\Layout([
                    ...
                    new CherrySite\Views\Widgets\Table\Actions('Действия', [
                        new CherrySite\Views\Widgets\Table\EditButton('admin.churches.edit'),
                        new CherrySite\Views\Widgets\Table\DeleteButton('admin.churches.destroy'),
                    ]),
                ], $paginator),
            ])
        );
    ...
    public function create(Request $request)
    {
        ...
        $widget = new CherrySite\Views\Common\Page(
            'Новая новость поддержки РПЦ',
            new CherrySite\Views\Common\Navbar(),
            new CherrySite\Views\Common\Container([
                new CherrySite\Views\Common\Panel('Новая новость поддержки РПЦ', [
                    new CherrySite\Views\Common\Breadcrumbs('admin.churches.create'),
                ]),
                new CherrySite\Views\Widgets\Form\TabsContainer([
                    new CherrySite\Views\Widgets\Form\TabItem('Основные настройки', [
                        new CherrySite\Views\Widgets\Form\Layout('admin.churches.store', 'POST', [
    ...
    public function edit(Request $request, Church $model)
    {
        $table = $model->getTable();

        $widget = new CherrySite\Views\Common\Page(
            'Редактирование новости поддержки РПЦ',
            new CherrySite\Views\Common\Navbar(),
            new CherrySite\Views\Common\Container([
                new CherrySite\Views\Common\Panel('Редактирование новости поддержки РПЦ', [
                    new CherrySite\Views\Common\Breadcrumbs('admin.churches.edit', $model),
                    new CherrySite\Views\Common\DeleteButton('admin.churches.destroy'),
                ]),
                new CherrySite\Views\Widgets\Form\TabsContainer([
                    new CherrySite\Views\Widgets\Form\TabItem('Основные настройки', [
                        new CherrySite\Views\Widgets\Form\Layout('admin.churches.update', 'PATCH', [
                            new CherrySite\Views\Widgets\Form\Text($table, 'title', 'Название'),
                            new CherrySite\Views\Widgets\Form\Text($table, 'place', 'Место'),
                            new CherrySite\Views\Widgets\Form\File($table, 'cover', 'Обложка'),
                            new CherrySite\Views\Widgets\Form\Wysiwyg($table, 'content_long', 'Описание, полное'),
                    ...
                    new CherrySite\Views\Widgets\Form\TabItem('Галлерея', [
                        new CherrySite\Views\Widgets\Form\HasManyToGallery(
                            ...
                            'path',
                            'position',
                            'admin.churches_photos.batchStore',
                            'admin.churches_photos.destroy',
                            'admin.churches_photos.batchUpdate'
                        ),
                    ]),
                ]),
            ])
    ...
    public function store(Request $request)
    {
        ...
        $connection = Church::resolveConnection();
        $query = Church::query();
        ...
        if ($result->succeeded()) {
            ...
            return response()
                ->json(['redirectTo' => route('admin.churches.edit', [$retriever->getModel()], false)]);
        }
    ...
    public function update(Request $request, Church $model)
    {
        $data = $this->validate($request, [
            'title' => 'required|string',
            'place' => 'nullable|string',
        ...
        if ($result->succeeded()) {
            $request->session()->flash('success', $result->messages());
            return response()
                ->json(['redirectTo' => route('admin.churches.index', [], false)]);
        }
    ...
    public function destroy(Request $request, Church $model)
    {
