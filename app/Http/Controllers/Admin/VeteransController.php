...
class VeteransController extends Controller
{
    public function index(Request $request)
    {
        ...
        $widget = new CherrySite\Views\Common\Page(
            ...
            new CherrySite\Views\Common\Container([
                new CherrySite\Views\Common\Panel('Помощь ветеранам войн', [
                    new CherrySite\Views\Common\Breadcrumbs('admin.veterans.index'),
                    new CherrySite\Views\Common\CreateButton('admin.veterans.create'),
                ]),
                new CherrySite\Views\Widgets\Table\Layout([
                    ...
                    new CherrySite\Views\Widgets\Table\Actions('Действия', [
                        new CherrySite\Views\Widgets\Table\EditButton('admin.veterans.edit'),
                        new CherrySite\Views\Widgets\Table\DeleteButton('admin.veterans.destroy'),
                    ]),
                ], $paginator),
            ])
        );
    ...
    public function create(Request $request)
    {
        ...
        $widget = new CherrySite\Views\Common\Page(
            'Новая новость помощи ветеранам войн',
            new CherrySite\Views\Common\Navbar(),
            new CherrySite\Views\Common\Container([
                new CherrySite\Views\Common\Panel('Новая новость помощи ветеранам войн', [
                    new CherrySite\Views\Common\Breadcrumbs('admin.veterans.create'),
                ]),
                new CherrySite\Views\Widgets\Form\TabsContainer([
                    new CherrySite\Views\Widgets\Form\TabItem('Основные настройки', [
                        new CherrySite\Views\Widgets\Form\Layout('admin.veterans.store', 'POST', [
    ...
    public function edit(Request $request, Veteran $model)
    {
        $table = $model->getTable();

        $widget = new CherrySite\Views\Common\Page(
            'Редактирование новости помощи ветеранам войн',
            new CherrySite\Views\Common\Navbar(),
            new CherrySite\Views\Common\Container([
                new CherrySite\Views\Common\Panel('Редактирование новости помощи ветеранам войн', [
                    new CherrySite\Views\Common\Breadcrumbs('admin.veterans.edit', $model),
                    new CherrySite\Views\Common\DeleteButton('admin.veterans.destroy'),
                ]),
                new CherrySite\Views\Widgets\Form\TabsContainer([
                    new CherrySite\Views\Widgets\Form\TabItem('Основные настройки', [
                        new CherrySite\Views\Widgets\Form\Layout('admin.veterans.update', 'PATCH', [
                            new CherrySite\Views\Widgets\Form\Text($table, 'title', 'Название'),
                            new CherrySite\Views\Widgets\Form\Text($table, 'place', 'Место'),
                            new CherrySite\Views\Widgets\Form\File($table, 'cover', 'Обложка'),
                            new CherrySite\Views\Widgets\Form\Wysiwyg($table, 'content_long', 'Описание, полное'),
                    ...
                    new CherrySite\Views\Widgets\Form\TabItem('Галлерея', [
                        new CherrySite\Views\Widgets\Form\HasManyToGallery(
                            ...
                            'path',
                            'position',
                            'admin.veterans_photos.batchStore',
                            'admin.veterans_photos.destroy',
                            'admin.veterans_photos.batchUpdate'
                        ),
                    ]),
                ]),
            ])
    ...
    public function store(Request $request)
    {
        ...
        $connection = Veteran::resolveConnection();
        $query = Veteran::query();
        ...
        if ($result->succeeded()) {
            ...
            return response()
                ->json(['redirectTo' => route('admin.veterans.edit', [$retriever->getModel()], false)]);
        }
    ...
    public function update(Request $request, Veteran $model)
    {
        $data = $this->validate($request, [
            'title' => 'required|string',
            'place' => 'nullable|string',
        ...
        if ($result->succeeded()) {
            $request->session()->flash('success', $result->messages());
            return response()
                ->json(['redirectTo' => route('admin.veterans.index', [], false)]);
        }
    ...
    public function destroy(Request $request, Veteran $model)
    {
