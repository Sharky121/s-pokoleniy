...
class ArtController extends Controller
{
    public function index(Request $request)
    {
        ...
        $widget = new CherrySite\Views\Common\Page(
            ...
            new CherrySite\Views\Common\Container([
                new CherrySite\Views\Common\Panel('Творческая мастерская', [
                    new CherrySite\Views\Common\Breadcrumbs('admin.art.index'),
                    new CherrySite\Views\Common\CreateButton('admin.art.create'),
                ]),
                new CherrySite\Views\Widgets\Table\Layout([
                    ...
                    new CherrySite\Views\Widgets\Table\Actions('Действия', [
                        new CherrySite\Views\Widgets\Table\EditButton('admin.art.edit'),
                        new CherrySite\Views\Widgets\Table\DeleteButton('admin.art.destroy'),
                    ]),
                ], $paginator),
            ])
        );
    ...
    public function create(Request $request)
    {
        ...
        $widget = new CherrySite\Views\Common\Page(
            'Новая новость творческой мастерской',
            new CherrySite\Views\Common\Navbar(),
            new CherrySite\Views\Common\Container([
                new CherrySite\Views\Common\Panel('Новая новость творческой мастерской', [
                    new CherrySite\Views\Common\Breadcrumbs('admin.art.create'),
                ]),
                new CherrySite\Views\Widgets\Form\TabsContainer([
                    new CherrySite\Views\Widgets\Form\TabItem('Основные настройки', [
                        new CherrySite\Views\Widgets\Form\Layout('admin.art.store', 'POST', [
    ...
    public function edit(Request $request, Art $model)
    {
        $table = $model->getTable();

        $widget = new CherrySite\Views\Common\Page(
            'Редактирование новости творческой мастерской',
            new CherrySite\Views\Common\Navbar(),
            new CherrySite\Views\Common\Container([
                new CherrySite\Views\Common\Panel('Редактирование новости творческой мастерской', [
                    new CherrySite\Views\Common\Breadcrumbs('admin.art.edit', $model),
                    new CherrySite\Views\Common\DeleteButton('admin.art.destroy'),
                ]),
                new CherrySite\Views\Widgets\Form\TabsContainer([
                    new CherrySite\Views\Widgets\Form\TabItem('Основные настройки', [
                        new CherrySite\Views\Widgets\Form\Layout('admin.art.update', 'PATCH', [
                            new CherrySite\Views\Widgets\Form\Text($table, 'title', 'Название'),
                            new CherrySite\Views\Widgets\Form\Text($table, 'place', 'Место'),
                            new CherrySite\Views\Widgets\Form\File($table, 'cover', 'Обложка'),
                            new CherrySite\Views\Widgets\Form\Wysiwyg($table, 'content_long', 'Описание, полное'),
                    ...
                    new CherrySite\Views\Widgets\Form\TabItem('Галлерея', [
                        new CherrySite\Views\Widgets\Form\HasManyToGallery(
                            ...
                            'path',
                            'position',
                            'admin.art_photos.batchStore',
                            'admin.art_photos.destroy',
                            'admin.art_photos.batchUpdate'
                        ),
                    ]),
                ]),
            ])
    ...
    public function store(Request $request)
    {
        ...
        $connection = Art::resolveConnection();
        $query = Art::query();
        ...
        if ($result->succeeded()) {
            ...
            return response()
                ->json(['redirectTo' => route('admin.art.edit', [$retriever->getModel()], false)]);
        }
    ...
    public function update(Request $request, Art $model)
    {
        $data = $this->validate($request, [
            'title' => 'required|string',
            'place' => 'nullable|string',
        ...
        if ($result->succeeded()) {
            $request->session()->flash('success', $result->messages());
            return response()
                ->json(['redirectTo' => route('admin.art.index', [], false)]);
        }
    ...
    public function destroy(Request $request, Art $model)
    {
