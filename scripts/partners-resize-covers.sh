#!/bin/bash
# Приводит public/images/partner-*.jpg к размеру 400×400 (квадрат для логотипов). ImageMagick или sips (macOS).
# Запуск из корня проекта: bash scripts/partners-resize-covers.sh
