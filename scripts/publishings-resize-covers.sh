#!/bin/bash
# Приводит public/images/publishing-*.jpg к размеру 800×600. ImageMagick или sips (macOS).
# Запуск из корня проекта: bash scripts/publishings-resize-covers.sh
